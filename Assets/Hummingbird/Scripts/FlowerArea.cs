...
/// <summary>
/// Manages a collections of flower plants and attached flowers
/// </summary>
public class FlowerArea : MonoBehaviour
{
    ...
    // List of all flower plants in this flower area (flower plants have multiple flowers)
    ...
    public void ResetFlowers()
    {
        ...
        foreach (GameObject flowerPlant in flowerPlants)
        {
            ...
            float yRotation = UnityEngine.Random.Range(-180, 180f);
    ...
    private void FindChildFlowers(Transform parent)
    {
        for (int i = 0; i < parent.childCount; i++)
        {
            ...
            {
                // Found a flower plant, add it to the flowersPlants list
